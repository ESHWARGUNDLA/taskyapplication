    ...
    <div class='col-md-6 col-lg-4 mt-3' id=${id} key=${id}>
        <div class='card shadow task__card'>
            <div class='card-header d-flex gap-2 justify-content-end task__card__header'>
                ...
                <button type='button' class='btn btn-outline-warning mr-2 name=${id}'><i class='fas fa-trash-alt'></i></button>
            </div>
            <div class='card-body'>
            ${
                url &&
                `img src=${url} alt='card image class='card-image-top' md-3 rounded-md'/>`
...
const htmltaskModal=({id,title,description,url}) => {
